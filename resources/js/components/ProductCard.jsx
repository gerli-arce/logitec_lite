...
export default function ProductCard({ product, onAddToCart, onWhatsApp }) {
  return (
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col h-full group overflow-hidden">
      {/* Image Container */}
      <Link to={`/producto/${product.id}`} className="relative aspect-square p-4 bg-white flex items-center justify-center overflow-hidden border-b border-gray-100 block">
      ...
      <div className="p-3 flex flex-col flex-1">
        ...
        {/* Title */}
        <h3 className="text-gray-800 font-medium text-xs leading-snug line-clamp-2 mb-2 flex-1 min-h-[2.5em]" title={product.nombre}>
