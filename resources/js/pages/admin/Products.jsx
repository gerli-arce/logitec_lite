...
export default function AdminProducts() {
  ...
  const formSubcategories = subcategories.filter(
    (sub) => sub.categoria_id === Number.parseInt(formData.categoria_id)
  );

  const filterSubcategories = subcategories.filter(
    (sub) =>
      !filters.categoria_id ||
      sub.categoria_id === Number.parseInt(filters.categoria_id)
  );
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            <div className="relative min-w-[200px]">
              <select
                ...
                onChange={(e) =>
                  handleFilterChange("categoria_id", e.target.value)
                }
            ...
            <div className="relative min-w-[200px]">
              <select
                ...
                onChange={(e) =>
                  handleFilterChange("subcategoria_id", e.target.value)
                }
                className="block w-full pl-3 pr-10 py-2 text-base border-gray-200 focus:outline-none focus:ring-[#0ACF83] focus:border-[#0ACF83] sm:text-sm rounded-lg bg-gray-50"
              >
            ...
            <div className="flex space-x-4">
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, promocion: e.target.checked })
                  }
                  className="w-4 h-4 text-[#0ACF83] border-gray-300 rounded focus:ring-[#0ACF83]"
                />
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-center">
                          <button
                            onClick={() =>
                              toggleProductStatus(product.id, "activo")
                            }
                        ...
                        <td className="px-6 py-4 text-center">
                          <div className="flex justify-center space-x-2">
                            <button
                              onClick={() =>
                                toggleProductStatus(product.id, "destacado")
                              }
                              title="Destacado"
                            ...
                            <button
                              onClick={() =>
                                toggleProductStatus(product.id, "promocion")
                              }
                              title="Promoci?n"
                              className={`p-1 rounded-full transition-colors ${
                                product.promocion
