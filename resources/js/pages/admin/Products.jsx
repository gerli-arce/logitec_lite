...
export default function AdminProducts() {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirm("Ã‚Â¿EstÃƒÂ¡s seguro de que deseas eliminar este producto?")) {
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Gestiona tu catÃƒÂ¡logo de productos</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            ...
            <div className="relative min-w-[200px]">
              ...
              >
                ...
                <option value="">Todas las subcategorÃƒÂ­as</option>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4" onPaste={handlePaste}>
            ...
            <div>
              ...
              <label className="block text-sm font-medium text-gray-700 mb-1">DescripciÃƒÂ³n</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <label className="block text-sm font-medium text-gray-700 mb-1">CategorÃƒÂ­a</label>
                ...
                >
                  ...
                  <option value="">Seleccionar categorÃƒÂ­a</option>
              ...
              <div>
                ...
                <label className="block text-sm font-medium text-gray-700 mb-1">SubcategorÃƒÂ­a</label>
                ...
                >
                  ...
                  <option value="">Seleccionar subcategorÃƒÂ­a</option>
                ...
                <div className="space-y-1 text-center">
                  ...
                  {imagePreview ? (
                    ...
                    <>
                      ...
                      <p className="text-xs text-blue-500 mt-2">Tip: Puedes pegar (Ctrl+V) una imagen aquÃƒÂ­</p>
            ...
            <div className="flex space-x-4">
              ...
              <div className="flex items-center">
                ...
                <label className="ml-2 text-sm text-gray-700">En PromociÃƒÂ³n</label>
              ...
              <table className="w-full whitespace-nowrap">
                ...
                <tbody className="divide-y divide-gray-100">
                  ...
                  {products.map((product) => {
                    ...
                    const imageSrc = product.imagen_principal
                        ...
                        <td className="px-6 py-4">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="h-12 w-12 flex-shrink-0 rounded-lg border border-gray-100 overflow-hidden bg-white">
                              ...
                              <img src={imageSrc} alt={product.nombre} className="h-full w-full object-cover" />
